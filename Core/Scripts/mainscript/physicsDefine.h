...
struct PhysicalEntity {
	...
	glm::mat3 inertiaTensorLocal = glm::mat3(0.0f);
    glm::mat3 inertiaTensorLocalInv = glm::mat3(0.0f);
    glm::mat3 inertiaTensorWorld = glm::mat3(0.0f);
    glm::mat3 inertiaTensorWorldInv = glm::mat3(0.0f);
